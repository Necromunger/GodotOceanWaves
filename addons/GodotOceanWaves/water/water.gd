...
const WATER_MAT := preload('res://addons/GodotOceanWaves/water/mat_water.tres')
const SPRAY_MAT := preload('res://addons/GodotOceanWaves/water/mat_spray.tres')
const WATER_MESH_HIGH := preload('res://addons/GodotOceanWaves/water/clipmap_high.obj')
const WATER_MESH_LOW := preload('res://addons/GodotOceanWaves/water/clipmap_low.obj')
