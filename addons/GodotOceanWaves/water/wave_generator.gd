...
func init_gpu(num_cascades : int) -> void:
	...
	var spectrum_compute_shader := context.load_shader('./addons/GodotOceanWaves/shaders/compute/spectrum_compute.glsl')
	var fft_butterfly_shader := context.load_shader('./addons/GodotOceanWaves/shaders/compute/fft_butterfly.glsl')
	var spectrum_modulate_shader := context.load_shader('./addons/GodotOceanWaves/shaders/compute/spectrum_modulate.glsl')
	var fft_compute_shader := context.load_shader('./addons/GodotOceanWaves/shaders/compute/fft_compute.glsl')
	var transpose_shader := context.load_shader('./addons/GodotOceanWaves/shaders/compute/transpose.glsl')
	var fft_unpack_shader := context.load_shader('./addons/GodotOceanWaves/shaders/compute/fft_unpack.glsl')
